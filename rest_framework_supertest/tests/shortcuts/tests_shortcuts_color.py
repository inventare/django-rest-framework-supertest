...
class ColorShortcutsTests(FakerMockMixin, TestCase):
    def test_color(self):
        hue = 180
        luminosity = 'dark'
        color_format = 'rgb'
    ...
    def test_unique_rgb_css_color(self):
    ...
    def test_unique_safe_color_name(self):
    ...
    def test_unique_safe_hex_color(self):
