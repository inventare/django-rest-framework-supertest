...
class InitFakerTestCase(TestCase):
    ...
    @override_settings(FAKER_ADD_PROVIDERS='tests.tests_faker.tests_init_faker.add_providers')
    @patch('tests.tests_faker.tests_init_faker.add_providers')
    ...
    @override_settings(FAKER_ADD_PROVIDERS='tests.tests_faker.tests_init_faker.fake')
